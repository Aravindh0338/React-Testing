    ...
    <div className="formFieldWrapper" data-testid="formfield">
      ...
      <form className="mainFormWrap" onSubmit={formik.handleSubmit}>
        ...
        <div className="formWrapper">
          ...
          <p className={ formik.touched.gender && formik.errors.gender ? "displayBlock"  : "displayNone"}> {formik.errors.gender}</p>
          ...
          <button data-testid="submit" className="btn" type="submit">Register</button>
        </div>
      </form>
    </div>
  );
